...
describe('ToolInvocationHeader', () => {
  ...
  it('should render suggestions when provided', () => {
    const propsWithSuggestions = {
      ...
      suggestions: [
        {
          type: 'SUGGESTION_TYPE_CHAT' as const,
          text: 'Ask about React',
          value: 'Tell me about React',
        },
        {
          type: 'SUGGESTION_TYPE_CHAT' as const,
          text: 'Ask about Vue',
          value: 'Tell me about Vue',
        },
      ],
    };
  ...
  it('should truncate long parameter values', () => {
    ...
    const paramElement = screen.getByText(
      'This is a very long query that should be truncated in the UI',
    );
