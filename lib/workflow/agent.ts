...
async function workflowBuilderAgent({
  ...
  const { text } = await generateText({
    ...
    tools: {
      ...
      editBooleanTool: editBooleanNodeTool(workflow),
      editConverterTool: editConverterNodeTool(workflow),
      editFixedInputTool: editFixedInputTool(workflow),
    },
    system: prompt,
