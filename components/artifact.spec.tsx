...
jest.mock('./artifact-messages', () => ({
  ArtifactMessages: () => (
    <div data-testid="artifact-messages">Artifact Messages</div>
  ),
}));
jest.mock('./artifact-close-button', () => ({
  ArtifactCloseButton: () => (
    <div data-testid="artifact-close-button">Close</div>
  ),
}));
...
jest.mock('@/artifacts/flowchart/client', () => ({
  flowchartArtifact: {
    kind: 'flowchart',
    content: () => <div>Flowchart Artifact</div>,
  },
}));
...
describe('Artifact', () => {
  ...
  it('should render artifact title and content', () => {
    ...
    expect(screen.getByTestId('artifact-content')).toHaveTextContent(
      'Test content',
    );
  });
  ...
  it('should apply correct CSS classes to main container', () => {
    ...
    expect(artifactContainer).toHaveClass(
      'flex',
      'flex-row',
      'h-dvh',
      'w-dvw',
