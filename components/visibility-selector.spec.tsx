...
describe('VisibilitySelector', () => {
  ...
  it('should show correct icon and label for private visibility', () => {
    render(<VisibilitySelector {...defaultProps} selectedVisibilityType="private" />);
  ...
  it('should show correct icon and label for public visibility', () => {
    const mockUseChatVisibility = require('@/hooks/use-chat-visibility').useChatVisibility;
    mockUseChatVisibility.mockReturnValue({
      visibilityType: 'public',
      setVisibilityType: jest.fn()
    });

    render(<VisibilitySelector {...defaultProps} selectedVisibilityType="public" />);
